  ...
  return (
    <PageShell testId="compare-page">
      ...
      <div className="relative max-w-5xl mx-auto px-6 lg:px-10 pb-24 lg:pb-32">
        <div className="flex items-start gap-3 rounded-2xl bg-nua-bgAlt border border-nua-border p-4" data-testid="compare-disclaimer">
        ...
        <div className="mt-8 grid sm:grid-cols-2 gap-4">
          {compareData.map((c, i) => (
            ...
            >
              ...
              <p className="mt-2 text-[13px] text-nua-ink2 leading-relaxed">{c.summary}</p>
            </MotionLink>
          ))}
        </div>

        <p className="mt-8 text-center text-[11px] text-nua-muted max-w-2xl mx-auto">
