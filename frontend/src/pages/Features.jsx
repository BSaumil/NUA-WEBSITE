          ...
          {featuresData.map((f, i) => {
            ...
            return (
              <motion.section
                ...
                className="rounded-3xl border border-nua-border bg-nua-surface p-6 sm:p-8 lg:p-10"
              >
                <div className="grid lg:grid-cols-12 gap-8">
                  ...
                  <div className="lg:col-span-4 flex flex-col justify-center">
                    <span className="mb-2 font-mono text-[10px] uppercase tracking-widest text-nua-ink2">Interface</span>
                    {Visual && <Visual />}
                  </div>

                  {/* How it works: plain-language steps, no code */}
                  <div className="lg:col-span-4 flex flex-col justify-center">
                    <span className="mb-2 font-mono text-[10px] uppercase tracking-widest text-nua-ink2">How it works</span>
                    <div className="rounded-2xl bg-nua-bgAlt border border-nua-border p-5">
                      <ol className="space-y-4">
                        {f.howItWorks.map((step, idx) => (
                          <li key={step} className="flex items-start gap-3">
                            ...
                            <span className="text-[13px] text-nua-ink leading-relaxed pt-0.5">{step}</span>
                          </li>
                        ))}
                      </ol>
                    </div>
